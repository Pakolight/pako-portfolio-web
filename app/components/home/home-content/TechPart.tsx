    ...
    return(
        <div className="mx-auto max-w-2xl px-2 lg:max-w-7xl lg:px-8">
            ...
            <motion.p
                ...
                <Trans
                    i18nKey="homeContent.serverOrientedSection"
                    components={[
            ...
            <article className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-8 lg:grid-rows-2">
                <motion.div
                    ...
                    <div className="pt-8 w-full overflow-hidden rounded-lg bg-white shadow-sm outline outline-black/5 max-lg:rounded-t-4xl lg:rounded-tl-4xl dark:bg-gray-800 dark:shadow-none dark:outline-white/15">
                        <div className="mx-2 bg-[url('/public/img/home-context/inBrowserMobile.png')] md:bg-[url('/public/img/home-context/inBrowser.png')]bg-cover h-80 bg-[position:center_-5%] md:bg-contain md:bg-no-repeat"/>
                        <div className="px-8">
                            ...
                            <p className="mb-6 text-base/7 text-gray-600 dark:text-gray-400">
                                <Trans i18nKey="homeContent.ssrPreference" components={[emphasis]} />
                            </p>
                            <p className="mb-6 text-base/7 text-gray-600 dark:text-gray-400">
                                <Trans
                                    i18nKey="homeContent.frameworkChoice"
                                    components={[emphasis, emphasis, emphasis]}
                                />
                            </p>
                            <p className="mb-8 text-base/7 text-gray-600 dark:text-gray-400">
                                <Trans i18nKey="homeContent.serverRuntime" components={[emphasis]} />
                            </p>
                            <p className="mb-8 text-base/7 text-gray-600 dark:text-gray-400">
                                <Trans i18nKey="homeContent.formsPreference" components={[emphasis]} />
                            </p>
                        </div>
                    </div>
                </motion.div>
                <motion.div
                    ...
                    <div className="pt-8 w-full overflow-hidden rounded-lg bg-white shadow-sm outline outline-black/5 lg:rounded-tr-4xl dark:bg-gray-800 dark:shadow-none dark:outline-white/15">
                        <div className="
                                        mx-2 bg-[url('/public/img/home-context/backEnd.png')]
                        ...
                        <div className="px-8">
                            ...
                            <p className="mb-6 text-base/7 text-gray-600 dark:text-gray-400">
                                <Trans i18nKey="homeContent.backendIntro" components={[emphasis]} />
                            </p>
                            <p className="mb-6 text-base/7 text-gray-600 dark:text-gray-400">
                                <Trans
                                    i18nKey="homeContent.backendProtocols"
                                    components={[emphasis, emphasis, emphasis]}
                                />
                            </p>
                            <p className="mb-8 text-base/7 text-gray-600 dark:text-gray-400">
                                <Trans
                                    i18nKey="homeContent.nodeStack"
                                    components={[emphasis, emphasis, emphasis, emphasis]}
                                />
                            </p>
                        </div>
                    </div>
                ...
                <motion.div
                    ...
                    <div className="pt-8 w-full overflow-hidden rounded-lg bg-white shadow-sm outline outline-black/5 lg:rounded-bl-4xl dark:bg-gray-800 dark:shadow-none dark:outline-white/15">
                        <div className="
                                        mx-2 bg-[url('/public/img/home-context/IsometricAI.png')]
                                        h-80 bg-[position:center_45%] bg-contain bg-no-repeat  md:bg-[position:center_40%]"/>
                        <div className="p-10">
                            <h2 className="mb-2 text-2xl font-semibold tracking-tight text-pretty text-gray-900 dark:text-white">
                                {t("homeContent.devOpsQuality")}
                            </h2>
                            <p className="mb-6 text-base/7 text-gray-600 dark:text-gray-400">
                                <Trans i18nKey="homeContent.testingMindset" components={[emphasis]} />
                            </p>

                            <p className="mb-8 text-base/7 text-gray-600 dark:text-gray-400">
                                <Trans
                                    i18nKey="homeContent.ciCdStack"
                                    components={[emphasis, emphasis, emphasis, emphasis, emphasis]}
                                />
                            </p>
                        </div>
                    </div>
                ...
                <motion.div
                    ...
                    <div className="pt-8 w-full overflow-hidden rounded-lg bg-white shadow-sm outline outline-black/5 max-lg:rounded-b-4xl lg:rounded-br-4xl dark:bg-gray-800 dark:shadow-none dark:outline-white/15">
                        <div className="
                                        mx-2 bg-[url('/public/img/home-context/businessStrategies.png')]
                                        h-80 bg-[position:center_45%] bg-contain bg-no-repeat  md:bg-[position:center_40%] "/>
                        <div className="p-10">
                            <h2 className="mb-2 text-2xl font-semibold tracking-tight text-pretty text-gray-900 dark:text-white">
                                {t("homeContent.engineeringBackground")}
                            </h2>

                            <p className="mb-6 text-base/7 text-gray-600 dark:text-gray-400">
                                <Trans
                                    i18nKey="homeContent.engineeringBackgroundIntro"
                                    components={[emphasis, emphasis, emphasis]}
                                />
                            </p>
                            ...
                            <p className="mb-8 text-base/7 text-gray-600 dark:text-gray-400">
                                <Trans
                                    i18nKey="homeContent.engineeringBackgroundWeb"
                                    components={[emphasis, emphasis, emphasis, emphasis]}
                                />
                            </p>
