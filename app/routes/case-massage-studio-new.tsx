...
export default function CaseMassageStudio() {
    ...
    const tabs = [
        { name: t("massageStudio.title"), to: 'problem-solution'},
        { name: t("massageStudio.MVPHeading"), to: 'mvp'},
        { name: t("massageStudio.roadmapTitle"), to: 'roadmap'},
        { name: t("massageStudio.valueTitle"), to: 'values-for-business'},
        { name: t("massageStudio.techStackTitle"), to: 'techstack'},
    ]
