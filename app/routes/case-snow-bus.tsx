...
export default function CaseTelegramMedicalBot() {
    ...
    const tabs = [
        ...
        { name: t("transportOps.roadmapTitle"), to: 'roadmap'},
        { name: t("transportOps.valueTitle"), to: 'values-for-business'},
        { name: t("transportOps.techStackTitle"), to: 'techstack'},
    ]
                ...
                <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                    <div className="lg:pr-4">
                        ...
                        <div className="lg:max-w-lg">
                            <p className="text-base/7 font-semibold text-indigo-600 dark:text-indigo-400">{t("transportOps.message")}</p>
                            <h1 className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl dark:text-white">
                                {t("transportOps.title")}
                            </h1>
                            <Outlet/>
